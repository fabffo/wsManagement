...
///     PROGRAMME FORM TYPE MISSION MAJ                                   ///
...
public final class MajTypeContratSocieteForm {
    ...
    public TypeContratSociete modifierTypeContratSociete( HttpServletRequest request ) {
