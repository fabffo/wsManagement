...
///     PROGRAMME FORM TYPE SOCIETE COPIE                                 ///
...
public final class CopieTypeSocieteForm {
    ...
    public TypeSociete copierTypeSociete( HttpServletRequest request ) {
        ...
        if ( erreurs.isEmpty() ) {
            resultat = "Succès de la copie de la TypeSociete.";
        } else {
            resultat = "Échec de la copie de la TypeSociete.";
        }
        return typeSociete;
    }
    ...
    private String validationCode( String nom ) throws Exception {
        ...
        if ( temp != null ) {
            ...
            Boolean existe = typeSocieteDao.trouverNomTypeSociete(nom);
            	if ( existe == true ) {
