...
public final class MajSocieteForm {
	...
	public Societe modifierSociete(HttpServletRequest request) {
		...
		contact_principal = request.getParameter("contact_principal");
		...
		societe.setId_contact_principal(id);
		societe.setContact_principal(contact_principal);
