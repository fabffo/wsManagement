...
///     PROGRAMME FORM TYPE CONTRAT CREATION                              ///
...
public final class CreationTypeCollaborateurForm {
    ...
    public TypeContratCollaborateur creerTypeContratCollaborateur( HttpServletRequest request ) {
