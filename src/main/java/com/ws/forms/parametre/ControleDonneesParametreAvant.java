...
public final class ControleDonneesParametreAvant {
	...
	public Object ControlerDonneesParametre(HttpServletRequest request) {
     ...
     // Boucle sur chaque configuration pour ajouter les validations dynamiquement
		  ...
		  // Ajouter la configuration pour "libelle"
		  configLibelle.put("required",true);
		  configLibelle.put("minlength", 3);
		  configLibelle.put("maxLength", 10);
		  ...
		  // Ajouter la configuration pour "taux"
		  configTaux.put("valeur",(request.getParameter("taux")));
		  configTaux.put("required", false);
		  configTaux.put("minlength", 3);
		  configTaux.put("maxlength", 5);
		  configTaux.put("type", "number");
		  configTaux.put("step", "0.01");
		  configTaux.put("placeholder", "0.00");
		  validations.put("taux", configTaux);
