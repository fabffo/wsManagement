...
///     PROGRAMME FORM UTILISATEUR  COPIE                                 ///
...
public final class CopieUtilisateurForm {
    ...
    public Utilisateur copierUtilisateur( HttpServletRequest request ) {
        ...
        if ( erreurs.isEmpty() ) {
            resultat = "Succès de la copie de la Utilisateur.";
        } else {
            resultat = "Échec de la copie de la Utilisateur.";
        }
        return utilisateur;
    }
    ...
    private String validationCode( String nom ) throws Exception {
        ...
        if ( temp != null ) {
            ...
            Boolean existe = utilisateurDao.trouverNomUtilisateur(nom);
            	if ( existe == true ) {
