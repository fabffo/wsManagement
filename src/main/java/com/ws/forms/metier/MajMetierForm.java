...
public final class MajMetierForm {
    ...
    public Metier modifierMetier( HttpServletRequest request ) {
        ...
        System.out.print("majmission" +metier.toString());
        if ( erreurs.isEmpty() ) {
