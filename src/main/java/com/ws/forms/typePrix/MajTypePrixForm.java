...
public final class MajTypePrixForm {
    ...
    public TypePrix modifierTypePrix( HttpServletRequest request ) {
        ...
        System.out.print("majmission" +typePrix.toString());
        if ( erreurs.isEmpty() ) {
