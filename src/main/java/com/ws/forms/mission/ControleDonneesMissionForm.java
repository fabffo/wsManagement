...
public final class ControleDonneesMissionForm {
	...
	public Mission ControlerDonneesMission(HttpServletRequest request) {
		...
		// ======ID ET VERSION CONTRAT
				try {
					...
					valeurVersion_contrat = Integer.parseInt(valeurIdEtContrat[1]);
				} catch (Exception e) {
				...
				System.out.println("date"+valeurDate_demarrage);
		...
		System.out.println("nom"+nom_mission);
		try {
