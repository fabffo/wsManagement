...
public final class ControleRenommageContratForm {
	...
	public ContratAncien RenommerContrat(HttpServletRequest request, ContratAncien contrat) {
...
// =====STATUT
		...
		try {
			valeurNom_contrat = validationStatut(nom_contrat);
		} catch (Exception e) {
		...
		contrat.setNom_contrat(nom_contrat);
		System.out.println(resultat);
		System.out.println(nom_contrat);
		return contrat;
	}
	...
	// =============================================================================================================//
	// =====STATUT
	private String validationStatut(String nom_contrat) throws Exception {
		String temp = nom_contrat;
		if (temp != null) {
			if(contratDao.trouverNomContrat(temp)) {
				throw new Exception("le contrat "+ temp + "existe déjà");
			}else
				{}
		} else {
			throw new Exception("Choisir un nom contrat.");
		}
		return temp;
	}
