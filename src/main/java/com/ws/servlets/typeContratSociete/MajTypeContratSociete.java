...
///     PROGRAMME SERVLET TYPE MISSION MAJ                                ///
 ...
 */
public class MajTypeContratSociete extends HttpServlet {
    ...
    public static final String VUE_FORM        = "/WEB-INF/JSP_typeContratSociete/majTypeContratSociete.jsp";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		this.getServletContext().getRequestDispatcher("/WEB-INF/JSP_typeContratSociete/majTypeContratSociete.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		MajTypeContratSocieteForm form = new MajTypeContratSocieteForm();
		/* Traitement de la requête et récupération du bean en résultant */
        TypeContratSociete typeContratSociete = form.modifierTypeContratSociete( request );
		...
		if (form.getErreurs().isEmpty()) {
			try {
				typeContratSocieteDao.modifierTypeContratSociete(typeContratSociete);
			} catch (DaoException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
