 ...
 */
public class AnnulationMission extends HttpServlet {
	// ===========================================================================
		...
		public static final String VUE_FORM = "/WEB-INF/JSP_mission/annulationMission.jsp";
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response)
			...
			// -------------------------------------------------------------------
			ControleAnnulationMissionForm formD = new ControleAnnulationMissionForm();
			/* Traitement de la requête et récupération du bean en résultant */
			// ---------------------------------------------------------------------
				mission = formD.AnnulerMission(request, mission);
			...
			if ((formD.getErreurs().isEmpty())) {
				try {
					missionDao.annulerMission(mission);
				} catch (DaoException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
