...
///     PROGRAMME SERVLET TYPEPRIX COPIE                               ///
...
import com.ws.forms.typePrix.CopieTypePrixForm;
 ...
 */
public class CopieTypePrix extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String ATT_TYPEPRIX      = "typePrix";
    public static final String ATT_FORM        = "form";
    public static final String VUE_SUCCES      = "gestionTypePrix";
    public static final String VUE_FORM        = "/WEB-INF/JSP_typePrix/copieTypePrix.jsp";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		this.getServletContext().getRequestDispatcher("/WEB-INF/JSP_typePrix/copieTypePrix.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		CopieTypePrixForm form = new CopieTypePrixForm();
		/* Traitement de la requête et récupération du bean en résultant */
        TypePrix typePrix = form.copierTypePrix( request );
		...
		if (form.getErreurs().isEmpty()) {
			try {
				typePrixDao.copierTypePrix(typePrix);
			} catch (DaoException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
