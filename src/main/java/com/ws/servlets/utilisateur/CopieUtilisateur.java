...
///     PROGRAMME SERVLET UTILISATEUR COPIE                               ///
...
import com.ws.forms.utilisateur.CopieUtilisateurForm;
 ...
 */
public class CopieUtilisateur extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String ATT_UTILISATEUR      = "utilisateur";
    public static final String ATT_FORM        = "form";
    public static final String VUE_SUCCES      = "gestionUtilisateur";
    public static final String VUE_FORM        = "/WEB-INF/JSP_utilisateur/copieUtilisateur.jsp";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		this.getServletContext().getRequestDispatcher("/WEB-INF/JSP_utilisateur/copieUtilisateur.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		CopieUtilisateurForm form = new CopieUtilisateurForm();
		/* Traitement de la requête et récupération du bean en résultant */
        Utilisateur utilisateur = form.copierUtilisateur( request );
		...
		if (form.getErreurs().isEmpty()) {
			try {
				utilisateurDao.copierUtilisateur(utilisateur);
			} catch (DaoException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
