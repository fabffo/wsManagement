...
///     PROGRAMME SERVLET TYPE CONTRAT MAJ                                ///
...
/**
 * Servlet implementation class MajTypeContratCollaborateur
 */
public class MajTypeContratCollaborateur extends HttpServlet {
    ...
    public static final String VUE_FORM        = "/WEB-INF/JSP_typeContratCollaborateur/majTypeContratCollaborateur.jsp";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		this.getServletContext().getRequestDispatcher("/WEB-INF/JSP_typeContratCollaborateur/majTypeContratCollaborateur.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		MajTypeContratCollaborateurForm form = new MajTypeContratCollaborateurForm();
		/* Traitement de la requête et récupération du bean en résultant */
        TypeContratCollaborateur typeContratCollaborateur = form.modifierTypeContratCollaborateur( request );
		...
		if (form.getErreurs().isEmpty()) {
			try {
				typeContratCollaborateurDao.modifierTypeContratCollaborateur(typeContratCollaborateur);
			} catch (DaoException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
