...
///     PROGRAMME SERVLET TYPEDOCUMENT MAJ                                         ///
...
/**
 * Servlet implementation class MajTypeDocument
 */
public class MajTypeDocument extends HttpServlet {
    ...
    public static final String VUE_FORM        = "/WEB-INF/JSP_typeDocument/majTypeDocument.jsp";
...
rs = null;
query = "select statut, libelle from typecontratcollaborateur";
try {
	String contrat;
	List<String> listContrat = new ArrayList<String>();
	connexion = daoFactory.getConnection();
...
///////////////////
		...
		this.getServletContext().getRequestDispatcher("/WEB-INF/JSP_typeDocument/majTypeDocument.jsp").forward(request, response);
	}
...
///////////////////
		...
		MajTypeDocumentForm form = new MajTypeDocumentForm();
		/* Traitement de la requête et récupération du bean en résultant */
        TypeDocument typeDocument = form.modifierTypeDocument( request );
		...
		if (form.getErreurs().isEmpty()) {
			try {
				typeDocumentDao.modifierTypeDocument(typeDocument);
			} catch (DaoException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
