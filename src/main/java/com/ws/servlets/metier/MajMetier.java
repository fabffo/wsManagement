...
public class MajMetier extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		this.getServletContext().getRequestDispatcher("/WEB-INF/JSP_metier/majMetier.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		MajMetierForm form = new MajMetierForm();
		/* Traitement de la requête et récupération du bean en résultant */
        Metier metier = form.modifierMetier( request );
		...
		if (form.getErreurs().isEmpty()) {
			try {
				metierDao.modifierMetier(metier);
			} catch (DaoException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
