 ...
 */
public class MajCollaborateur extends HttpServlet {
    ...
    public static final String VUE_FORM        = "/WEB-INF/JSP_collaborateur/majCollaborateur.jsp";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		this.getServletContext().getRequestDispatcher("/WEB-INF/JSP_collaborateur/majCollaborateur.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.print("POST MODIF COLLAB");
		MajCollaborateurForm form = new MajCollaborateurForm();
		/* Traitement de la requête et récupération du bean en résultant */
        Collaborateur collaborateur = form.modifierCollaborateur( request );
		...
		if (form.getErreurs().isEmpty()) {
			try {
				collaborateurDao.modifierCollaborateur(collaborateur);
			} catch (DaoException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
