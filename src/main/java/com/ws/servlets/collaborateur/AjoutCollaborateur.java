...
///     PROGRAMME SERVLET COLLABORATEUR CREATION                          ///
...
/**
 * Servlet implementation class AjoutCollaborateur
 */
public class AjoutCollaborateur extends HttpServlet {
...
//Liste des types utilisateur
    ...
    //Liste des metiers
   	...
   	rs = null;
		...
		this.getServletContext().getRequestDispatcher("/WEB-INF/JSP_collaborateur/ajoutCollaborateur.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Collaborateur collaborateur = form.creerCollaborateur( request );
		...
		if (form.getErreurs().isEmpty()) {
			try {
				collaborateurDao.ajouterCollaborateur(collaborateur);
