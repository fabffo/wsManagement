	...
	<div class="container">
		<div class="row">
			<div
				...
				<h1 class="text-center btn btn-dark">Copie tva</h1>
				<form method="POST" action="copieTva">

					<div class="form-group row">
						<label for="id" class="col-2 col-form-label">Id</label>
						<div class="col">
							<input type="text" class="col-10 form-control" name="id"
								value=<c:out value="${tva.id}"/> readonly> <span
					...
					<div class="form-group row">
						...
						<div class="col">
							<input type="text" class="col-10 form-control" name="nom"
								value=<c:out value="${tva.nom}"/> > <span
					...
					<div class="form-group row">
						...
						<input type="text" class="col-10 form-control" name="taux"
								value=<c:out value="${tva.taux}"/> > <span
