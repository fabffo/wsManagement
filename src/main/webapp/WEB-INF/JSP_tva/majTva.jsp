	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6-md-6 col-sm-6 container justify-content-center card">
				...
				<h1 class="text-center btn btn-dark">Maj tva</h1>
				<form method="POST" action="majParametre?id=${tva.id}">
					<div class="form-group row">
						<label for="nom" step =""  class="col-2 col-form-label">Nom</label>
						<div class="col">
							<input type="text" class="col-10 form-control" name="nom"
								value=<c:out value="${tva.nom}"/> readonly> <span
					...
					<div class="form-group row">
						...
						<div class="col">
							<textarea name="libelle" step ="" class="col-10 form-control"><c:out
									value="${tva.libelle}" /></textarea>
					...
					<div class="form-group row">
						...
						<div class="col">
							<input type="text" class="col-10 form-control" name="taux"
								value="${tva.taux}"/> <span
								class="erreur text-danger ">${form.erreurs['taux']}</span>
						</div>
					</div>
