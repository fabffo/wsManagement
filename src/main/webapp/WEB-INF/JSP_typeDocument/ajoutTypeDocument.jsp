...
///     PROGRAMME JSP TYPEDOCUMENT CREATION                                        ///
...
<head>
<meta charset="UTF-8">
<title>Ajout typeDocument</title>
	...
	<div class="container">
		<div class="row">
			<div
				...
				<h1 class="text-center btn btn-dark">Ajout typeDocument</h1>
				<div class="card-body">
					<form method="POST" action="ajoutTypeDocument">
						...
						<div class="form-group row">
						<label for="cheminRelatif " class="col-sm-3 col-form-label">Chemin relatif</label>
						<div class="col-sm-9">
						
							<input type="text" class="form-control" name="cheminRelatif"
								placeholder="" value=${typeDocument.cheminRelatif}> 
								 <span class="erreur text-danger ">${form.erreurs['cheminRelatif']}</span>
						</div>
						</div>
						<div class="form-group row">
						<label for="cheminAbsolu" class="col-sm-3 col-form-label">Chemin absolu</label>
						<div class="col-sm-9">
						<input type="text" class="form-control" name="cheminAbsolu"
								placeholder="" value=${typeDocument.cheminAbsolu}> 
								<span class="erreur text-danger ">${form.erreurs['cheminAbsolu']}</span>				
						</div>
					</div>
						<div class="box-footer">
							<button type="submit" class="btn btn-primary">Valider  </button>
						<a href=gestionTypeDocument?ACTION=ANNULER class="btn btn-danger">Annuler </a> 
						</div>
					</form>
				</div>
			</div>
