...
<div class="container">
    <div class="row">
        <div class="col-md-3">
            <a class="btn En-cours btn-link btn p-2" href="crudParametreMultiligne?parametre_nom_programme=ajout&classe_id=0&parametre_nom=${parametre_nom}">
            ...
            <form class="form-inline float-md-right" method="GET" action="gestionParametre">
                ...
                <div class="form-group mr-2">
                    <select class="form-select" id="${critere_recherche_libelle}" name="${critere_recherche_libelle}">
        				...
        				<option ${listZonesDeRecherche.selected} value="${listZonesDeRecherche.nom}">${listZonesDeRecherche.valeur}</option>
    					</c:forEach>
                    </select>
                </div>
                <div class="form-group mr-2">
