...
<head>
    <meta charset="UTF-8">
    <title>Gérer</title>
    <link rel="stylesheet" href="stylesWavyBootstrap.css" />
...
<body>
    ...
    <jsp:include page="ENTETE_GESTION_PARAMETRE.jsp" />

    <!-- Inclusion des détails -->
    <jsp:include page="DETAIL_GESTION_PARAMETRE.jsp" />

    <!-- Inclusion du tableau -->
    <jsp:include page="TABLE_GESTION_PARAMETRE.jsp" />
