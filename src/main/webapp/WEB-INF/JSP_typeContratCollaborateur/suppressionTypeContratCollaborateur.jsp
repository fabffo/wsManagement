...
///     PROGRAMME JSP TYPE CONTRAT SUPPRESSION                            ///
...
<head>
<meta charset="UTF-8">
<title>Visualisation type contrat</title>
	...
	<div class="container">
		<div class="row">
			<div
				...
				<h1 class="text-center btn btn-danger">Suppression type contrat Collaborateur</h1>
				<div class="card-body">
					<form method="POST" action="suppressionTypeContratCollaborateur">
					<div class="form-group row">
						<label for="id" class="col-auto col-form-label">id</label>
						<div class="col">
							<input type="text" class="form-control" name="id"
								value=<c:out value="${typeContratCollaborateur.id}"/>  />
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col">
							<input type="text" class="form-control" name="nom"
								value=<c:out value="${typeContratCollaborateur.nom}"/> disabled="disabled"/>
						</div>
					</div>
					<div class="form-group row">
						<label for="libelle" class="col-auto col-form-label">libelle</label>
						<div class="col">
							<textarea type="text" class="form-control" name="libelle" disabled="disabled"><c:out value="${typeContratCollaborateur.libelle}"/></textarea>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col">
							<input type="text" class="form-control" name="statut"
								value=<c:out value="${typeContratCollaborateur.statut}"/> disabled="disabled"/>
						</div>
					</div>
