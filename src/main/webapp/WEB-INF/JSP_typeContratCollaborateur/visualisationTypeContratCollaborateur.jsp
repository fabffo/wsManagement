...
///     PROGRAMME JSP TYPE CONTRAT VISUALISATION                          ///
	...
	<div class="container">
		<div class="row">
			<div
				...
				<h1 class="text-center btn btn-dark">Maj type de contrat Collaborateur</h1>
				<form method="POST" action="majTypeContratCollaborateur">
					...
					<div class="form-group row">
						...
						<div class="col">
							<input type="text" class="col-10 form-control" name="nom"
								value=<c:out value="${typeContratCollaborateur.nom}"/> readonly> <span
