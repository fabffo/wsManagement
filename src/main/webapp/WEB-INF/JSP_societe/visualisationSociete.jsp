...
///     PROGRAMME JSP SOCIETE VISUALISATION                               ///
...
<head>
<meta charset="UTF-8">
<title>Visualisatio societe</title>
	...
	<div class="container">
		<div class="row">
			<div
				...
				<h1 class="text-center btn btn-dark">VISUALISATION SOCIETE ${societe.id}</h1>
			</div>
		</div>
	</div>
	<br>
	<div class="container">
		<form method="POST" action="visualisationSociete">
			<div class="row">
