...
<body>
	...
	<div class="row flex-lg-nowrap w-80">
		<div
			...
			<div class="card-body">
				<form method="POST" action="gestionTypePrix?action=VISUALISER">
					<div class="form-group row">
						<label for="id" class="col-auto col-form-label">Nom</label>
						<div class="col">
							<input type="text" class="form-control" name="id"
								value=<c:out value="${typePrix.id}"/> disabled="disabled" />
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col">
							<input type="text" class="form-control" name="nom"
								value=<c:out value="${typePrix.nom}"/> disabled="disabled" />
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col">
							<textarea type="text" class="form-control" name="libelle"
								disabled="disabled"><c:out
									value="${typePrix.libelle}" /></textarea>
						</div>
					</div>
					
					<div class="box-footer">
						<a href=gestionTypePrix?ACTION=ANNULER class="btn btn-danger">Annuler
						</a>
					</div>
				</form>
			</div>
		...
		<div
			...
			<div class="col">
			<p>	créé par <c:out value="${typePrix.usercreation}"/> le 
				<c:out value="${typePrix.datecreation}"/>
				par le pgm <c:out value="${typePrix.pgmcreation}" />
					</p>
					</div>
								<div class="col">
			<p>	modifié par <c:out value="${typePrix.usermodification}"/> le 
				<c:out value="${typePrix.datemodification}"/>
				par le pgm <c:out value="${typePrix.pgmmodification}" />
					</p>
					</div>
			</div>		</div>
