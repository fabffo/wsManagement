...
///     PROGRAMME JSP TYPE MISSION MAJ                                    ///
	...
	<div class="container">
		<div class="row">
			<div
				...
				<h1 class="text-center btn btn-dark">Maj type de mission</h1>
				<form method="POST" action="majTypeContratSociete">

					<div class="form-group row">
						<label for="id" class="col-2 col-form-label">Id</label>
						<div class="col">
							<input type="text" class="col-10 form-control" name="id"
								value=<c:out value="${typeContratSociete.id}"/> readonly> <span
					...
					<div class="form-group row">
						...
						<div class="col">
							<input type="text" class="col-10 form-control" name="nom"
								value=<c:out value="${typeContratSociete.nom}"/> readonly> <span
					...
					<div class="form-group row">
						...
						<div class="col">
							<select name="statut" class="col-10 form-control">
								<option selected>${typeContratSociete.statut}</option>
