...
///     PROGRAMME JSP TYPE MISSION COPIE                                  ///
	...
	<div class="container">
		<div class="row">
			<div
				...
				<h1 class="text-center btn btn-dark">Copie type de mission</h1>
				<form method="POST" action="copieTypeContratSociete">
					...
					<div class="form-group row">
						...
						<div class="col">
							<input type="text" class="col-10 form-control" name="nom"
								value=<c:out value="${typeContratSociete.nom}"/> > <span
