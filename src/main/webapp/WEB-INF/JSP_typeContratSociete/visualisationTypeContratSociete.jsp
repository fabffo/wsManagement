...
///     PROGRAMME JSP TYPE MISSION VISUALISATION                          ///
...
<body>
	...
	<div class="row flex-lg-nowrap w-80">
		<div
			...
			<div class="card-body">
				<form method="POST" action="gestionTypeContratSociete?action=VISUALISER">
					<div class="form-group row">
						<label for="id" class="col-auto col-form-label">Nom</label>
						<div class="col">
							<input type="text" class="form-control" name="id"
								value=<c:out value="${typeContratSociete.id}"/> disabled="disabled" />
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col">
							<input type="text" class="form-control" name="nom"
								value=<c:out value="${typeContratSociete.nom}"/> disabled="disabled" />
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col">
							<textarea type="text" class="form-control" name="libelle"
								disabled="disabled"><c:out
									value="${typeContratSociete.libelle}" /></textarea>
						</div>
					</div>
					<div class="form-group row">
						<label for="statut" class="col-auto col-form-label">statut</label>
						<div class="col">
							<input type="text" class="form-control" name="statut"
								value=<c:out value="${typeContratSociete.statut}"/> disabled="disabled"/>
						</div>
					</div>
					<div class="box-footer">
						<a href=gestionTypeContratSociete?ACTION=ANNULER class="btn btn-danger">Annuler
						</a>
					</div>
				</form>
			</div>
		...
		<div
			...
			<div class="col">
			<p>	créé par <c:out value="${typeContratSociete.usercreation}"/> le 
				<c:out value="${typeContratSociete.datecreation}"/>
				par le pgm <c:out value="${typeContratSociete.pgmcreation}" />
					</p>
					</div>
								<div class="col">
			<p>	modifié par <c:out value="${typeContratSociete.usermodification}"/> le 
				<c:out value="${typeContratSociete.datemodification}"/>
				par le pgm <c:out value="${typeContratSociete.pgmmodification}" />
					</p>
					</div>
			</div>		</div>
