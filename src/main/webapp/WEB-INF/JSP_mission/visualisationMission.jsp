...
///     PROGRAMME JSP MISSION VISUALISATION                               ///
...
<head>
<meta charset="UTF-8">
<title>Visualisation mission</title>
	...
	<div class="container">
		<div class="row">
			<div
				...
				<h1 class="text-center btn btn-dark">VISUALISATION MISSION ${type_entite} ${mission.id}</h1>
			</div>
		</div>
	</div>
	<br>
	<div class="container">
		<form method="POST" action="majMission"
