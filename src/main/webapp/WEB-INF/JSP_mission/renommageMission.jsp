...
///     PROGRAMME JSP MISSION RENOMMAGE                                  ///
	...
	<div class="container">
		<div class="row">
			<div
				...
				<h1 class="text-center btn btn-dark">RENOMMAGE MISSION ${type_entite} ${mission.id}</h1>
			</div>
		</div>
	</div>
	<br>
	<div class="container">
		<form method="POST" action="renommageMission"
