...
///     PROGRAMME JSP MISSION CREATION                                    ///
	...
	<div class="container">
		<div class="row">
			<div
				...
				<h1 class="text-center btn btn-dark">AJOUT MISSION ${type_entite}</h1>
			</div>
		</div>
	</div>
	<br>
						...
						<div class="col-10">
							Contrat <select name="contratInfo" class="col-10 form-control">
								<c:forEach var="listContrat"
									items="${listContrat}">
									<option value="${listContrat}">${listContrat}</option>
								</c:forEach>
						...
						<div class="col-3">
							Type de prix <select name="type_prix" class="col-10 form-control">
								<c:forEach var="listTypePrix"
									items="${listTypePrix}">
									<option value="${listTypePrix.nom}">${listTypePrix.libelle}</option>
								</c:forEach>
						...
						<div class="col-3">
							Tva <select name="code_tva" class="col-10 form-control">
								<c:forEach var="listTva"
									items="${listTva}">
									<option value="${listTva.nom}">${listTva.taux}  ${listTva.libelle}</option>
								</c:forEach>
