...
///     PROGRAMME JSP CONTACT VISUALISATION                               ///
...
<body>
	...
	<br><br>
	<div class="container">
		<form method="POST" action="visualisationContact?typeSociete=${typeSociete}&id=${contact.id}">
			<div class="row">
				<div class="container">
					<div class="row">
						<div
							class="col-lg-10-md-10 col-sm-10 container justify-content-center card">
							<h1 class="text-center btn btn-dark">VISUALISATION CONTACT :${contact.id}</h1>
						</div>
