...
<body>
	...
	<br><br>
	<div class="container">
		<form method="POST" action="majContact?typeSociete=${typeSociete}&id=${contact.id}">
			<div class="row">
				<div class="container">
					<div class="row">
						<div
							class="col-lg-10-md-10 col-sm-10 container justify-content-center card">
							<h1 class="text-center btn btn-dark">MAJ CONTACT ${contact.id}</h1>
						</div>
						...
						<div class="form-group row">
							<div class="col-4">
								Telephone<input type="text" name="telephone"
									class="form-control"
									value=<c:out value="${contact.telephone}" />> <span
									class="erreur text-danger ">${form.erreurs['telephone']}</span>
							</div>
							<div class="col-8">
								Email<input type="text" name="email" class="form-control"
									value=<c:out value="${contact.email}" />> <span
						...
						<div class="form-group row">
							<div class="col-4">
								Telephone 2<input type="text" name="telephone2"
									class="form-control"
									value=<c:out value="${contact.telephone_secondaire}" />>
								<span class="erreur text-danger ">${form.erreurs['telephone2']}</span>
							</div>
							<div class="col-8">
								Email 2<input type="text" name="email2"
									class="form-control"
									value=<c:out value="${contact.email_secondaire}" />> <span
