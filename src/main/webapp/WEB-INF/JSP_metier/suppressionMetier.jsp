...
///     PROGRAMME JSP METIER  SUPPRESSION                                 ///
	...
	<div class="container">
		<div class="row">
			<div
				...
				<h1 class="text-center btn btn-danger">Suppression Metier</h1>
				<div class="card-body">
					<form method="POST" action="suppressionMetier">
					<div class="form-group row">
						<label for="id" class="col-auto col-form-label">id</label>
						<div class="col">
							<input type="text" class="form-control" name="id"
								value=<c:out value="${metier.id}"/>  />
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col">
							<textarea type="text" class="form-control" name="domaine" disabled="disabled"><c:out value="${metier.domaine}"/></textarea>
						</div>
					</div>
