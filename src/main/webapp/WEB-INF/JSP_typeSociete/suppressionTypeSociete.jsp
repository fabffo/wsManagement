...
///     PROGRAMME JSP TYPE SOCIETE SUPPRESSION                            ///
	...
	<div class="container">
		<div class="row">
			<div
				...
				<h1 class="text-center btn btn-danger">Suppression type societe</h1>
				<div class="card-body">
					<form method="POST" action="suppressionTypeSociete">
					<div class="form-group row">
						<label for="id" class="col-auto col-form-label">id</label>
						<div class="col">
							<input type="text" class="form-control" name="id"
								value=<c:out value="${typeSociete.id}"/>  />
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col">
							<textarea type="text" class="form-control" name="libelle" disabled="disabled"><c:out value="${typeSociete.libelle}"/></textarea>
						</div>
					</div>

					<div class="box-footer">
						<button type="submit" class="btn btn-primary">Valider  </button>
						<a href=gestionTypeSociete?ACTION=ANNULER class="btn btn-danger">Annuler </a> 
					</div>
				</form>
				</div>
			</div>
