...
///     PROGRAMME JSP TYPE SOCIETE MAJ                                    ///
	...
	<div class="container">
		<div class="row">
			<div
				...
				<h1 class="text-center btn btn-dark">Maj type de societe</h1>
				<form method="POST" action="majTypeSociete">

					<div class="form-group row">
						<label for="id" class="col-2 col-form-label">Id</label>
						<div class="col">
							<input type="text" class="col-10 form-control" name="id"
								value=<c:out value="${typeSociete.id}"/> readonly> <span
					...
					<div class="form-group row">
						...
						<div class="col">
							<input type="text" class="col-10 form-control" name="nom"
								value=<c:out value="${typeSociete.nom}"/> readonly> <span
