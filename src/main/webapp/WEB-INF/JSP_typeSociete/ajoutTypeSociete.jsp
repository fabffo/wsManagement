...
///     PROGRAMME JSP TYPE SOCIETE CREATION                               ///
...
<head>
<meta charset="UTF-8">
<title>Ajout type societe</title>
	...
	<div class="container">
		<div class="row">
			<div
				...
				<h1 class="text-center btn btn-dark">Ajout type societe</h1>
				<div class="card-body">
					<form method="POST" action="ajoutTypeSociete">
						<div class="form-group row">
						<label for="nom " class="col-auto col-form-label">Nom</label>
						<div class="col">

							<input type="text" class="form-control" name="nom"
								placeholder="" value=${typeSociete.nom} >
						...
						<div class="col">
							<input type="text" class="form-control" name="libelle"
								placeholder="" value=${typeSociete.libelle}>
