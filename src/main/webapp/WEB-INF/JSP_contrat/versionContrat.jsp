...
<body>
	...
	<div class="container">
		<div class="row">
			<div
				...
				<h1 class="text-center btn btn-dark">FAIRE UN AVENANT AU CONTRATCLIENT ${ contrat.id }_${ contrat.version}
				</h1>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<form method="POST"
			action="versionContrat?id=${ contrat.id }&version=${ contrat.version }"
