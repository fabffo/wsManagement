...
///     PROGRAMME JSP CONTRATCLIENT FIN                                   ///
...
<body>
	...
	<div class="container">
		<div class="row">
			<div
				...
				<h1 class="text-center btn btn-dark">TERMINER CONTRATCLIENT ${ contrat.id }_${ contrat.version}
				</h1>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<form method="POST"
			action="finContrat?id=${ contrat.id }&version=${ contrat.version }"
			...
			<div class="row">
				...
				<div
					...
					<div class="form-group row">
						<div class="col-8">
							Nom contrat <input type="text" class="form-control" disabled="disabled"
								name="nom_contrat"
