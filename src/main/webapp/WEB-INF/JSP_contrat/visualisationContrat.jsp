...
///     PROGRAMME JSP CONTRATCLIENT VISUALISATION                         ///
	...
	<div class="container">
		<div class="row">
			<div
				...
				<h1 class="text-center btn btn-dark">VISUALISER CONTRATCLIENT ${ contrat.id }_${ contrat.version}
				</h1>
			</div>
		</div>
	</div>
			...
			<div class="row">
				...
				<div
					...
					<div class="form-group row">
						...
						<div class="col-3">
							Statut <select name="statut" id="statut" disabled="disabled"
