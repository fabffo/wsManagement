...
<body>
	...
	<div class="container">
		<div class="row">
			<div
				...
				<h1 class="text-center btn btn-dark">MAJ CONTRATCLIENT ${ contrat.id }_${ contrat.version}
				</h1>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<form method="POST"
			action="majContrat?id=${ contrat.id }&version=${ contrat.version }"
						...
						<div class="row justify-content-center">
							<div class="col-md-10">
								<div class="comment-section">
									...
									<c:choose>
										<c:when test="${ !empty NomfichierRecu }">
											<div class="form-group text-center">
												<a href="${contrat.cheminRelatif}${contrat.document}" target="_blank"
													id="pdfLink" class="hidden"> <img src="images/pdf.png"
													alt="PDF" class="pdf-thumbnail">
												</a>
												<p>${contrat.cheminRelatif}${contrat.document}?${System.currentTimeMillis()}</p>
