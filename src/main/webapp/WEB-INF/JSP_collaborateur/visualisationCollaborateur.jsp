...
///     PROGRAMME JSP COLLABORATEUR VISUALISATION                         ///
	...
	<div class="container">
		<div class="row">
			<div
				...
				<h1 class="text-center btn btn-dark">VISUALISATION COLLABORATEUR ${collaborateur.id}</h1>
			</div>
		</div>
	</div>
	<br>
	<div class="container">
		<form method="POST" action="gestionCollaborateur?action=VISUALISER">
			<div class="row">
