...
///     PROGRAMME JSP COLLABORATEUR MAJ                                   ///
	...
	<div class="container">
		<div class="row">
			<div
				...
				<h1 class="text-center btn btn-dark">MAJ COLLABORATEUR ${collaborateur.id}</h1>
			</div>
		</div>
	</div>
	<br>
	<div class="container">
		<form method="POST" action="majCollaborateur?id=${collaborateur.id}">
			<div class="row">
